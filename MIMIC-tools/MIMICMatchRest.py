...
with open('matches.pk', 'rb') as f:
    matches = pickle.load(f)

semeval_files = [k for k,v in matches if v[0] is None or v[2] < .95]
...
print 'Saving output'
with open('matches_rest.pk', 'wb') as f:
